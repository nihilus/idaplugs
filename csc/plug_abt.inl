...
/*****************************************************************************
 *                                                                           *
 * plug_abt.inl: about dialog common handler                                 *
 * (c) 2003-2008 servil                                                      *
 *                                                                           *
 *****************************************************************************/
...
public:
	...
	module_player(HINSTANCE const hInstance, LPCTSTR const ModuleId,
		MLOADER &ldr, HWND const hwnd = NULL, bool const infinite = false,
		DWORD const fade_speed = 30) throw(exception) :
	...
	module_player(const void *const pvModule, size_t const cbSize,
		MLOADER &ldr, HWND const hwnd = NULL, bool const infinite = false,
		DWORD const fade_speed = 30) throw(exception) :
...
void window_fadein(HWND const hwnd, DWORD const Speed = 10) throw(exception) {
